      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-sm mt-1">Sign in to your PresentoAI account.</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-gray-500 text-xs font-medium uppercase tracking-wider">or sign in with email</span>
            <div className="flex-1 h-px bg-gray-700" />
          </div>
